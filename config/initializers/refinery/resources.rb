...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret          = "9aa18f8a1e5d89eb38bcc0b3cdfe855c73d8a50b0290f7cd"
  # config.dragonfly_url_host        = ""
  # config.dragonfly_datastore_root_path = "/Users/suketaku/cms_test/rickrockstar/public/system/refinery/resources"
